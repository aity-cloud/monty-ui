...
export const LOG_HEADERS = [
  {
    name:      'collapse',
    labelKey:  'monty.tableHeaders.empty',
    formatter: 'Collapse',
    value:     'timestamp',
    sort:      false,
    width:     '20px'
  ...
  {
    name:      'date',
    labelKey:  'monty.tableHeaders.date',
    formatter: 'Date',
    value:     'timestamp',
    sort:      false,
    width:     '300px'
  ...
  {
    name:          'namespace',
    labelKey:      'monty.tableHeaders.namespace',
  ...
  {
    name:          'podName',
    labelKey:      'monty.tableHeaders.podName',
...
<template>
  <Drawer :open="isOpen" @close="close">
    <template #title>
      <div class="p-5 pb-0">
        <h1>{{ t('monty.logsDrawer.title') }}</h1>
      </div>
    </template>
