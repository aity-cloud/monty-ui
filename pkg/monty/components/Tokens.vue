  ...
  data() {
    return {
      ...
      headers:  [
        {
          name:          'nameDisplay',
          labelKey:      'monty.tableHeaders.token',
          sort:          ['nameDisplay'],
          value:         'nameDisplay',
          width:         undefined,
          formatter:     'Token',
        ...
        {
          name:          'labels',
          labelKey:      'monty.tableHeaders.labels',
          sort:          ['labels'],
          value:         'labels',
        ...
        {
          name:      'capabilities',
          labelKey:  'monty.tableHeaders.capabilities',
          sort:      ['capabilities'],
          value:     'capabilities',
          formatter: 'ListBubbles'
        },
        {
          name:          'used',
          labelKey:      'monty.tableHeaders.used',
          sort:          ['used'],
          value:         'usedDisplay',
        ...
        {
          name:          'expirationDate',
          labelKey:      'monty.tableHeaders.expiration',
          sort:          ['expirationDate'],
