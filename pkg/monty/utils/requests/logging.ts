...
export async function getStorageClasses(): Promise<string[]> {
  return (await axios.get('/monty-api/LoggingAdmin/logging/storageclasses')).data?.storageClasses || [];
}

export async function getLoggingCluster(): Promise<OpensearchCluster> {
  return (await axios.get('/monty-api/LoggingAdmin/logging/cluster')).data;
}

export async function deleteLoggingCluster(): Promise<any> {
  await axios.delete('/monty-api/LoggingAdmin/logging/cluster');
}

export async function upsertLoggingCluster(cluster: OpensearchCluster): Promise<any> {
  return await axios.put('/monty-api/LoggingAdmin/logging/cluster', cluster);
}

export async function isLoggingClusterUpgradeAvailable(): Promise<UpgradeAvailableResponse> {
  return (await axios.get('/monty-api/LoggingAdmin/logging/upgrade/available')).data;
}

export async function upgradeLoggingCluster() {
  await axios.post('/monty-api/LoggingAdmin/logging/upgrade/do');
}
...
export async function getLoggingStatus(): Promise<UpgradeAvailableResponse> {
  return (await axios.get < UpgradeAvailableResponse>('/monty-api/LoggingAdmin/logging/status')).data;
}
